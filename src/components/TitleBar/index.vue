<template>
  ...
  <nut-tabbar unactive-color="#364636" active-color="#1989fa" @tab-switch="tabSwitch">
    ...
    <nut-tabbar-item :tab-title="$t('tabbar.myCourse')" font-class-name="iconfont" class-prefix="icon" icon="list" />
    <nut-tabbar-item :tab-title="$t('tabbar.news')" font-class-name="iconfont" class-prefix="icon" icon="news" />
  </nut-tabbar>
</template>
